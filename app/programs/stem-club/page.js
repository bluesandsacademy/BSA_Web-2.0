...
export default function STEMClubPage() {
  return (
    <>
      <section className="relative bg-secondary overflow-hidden py-28 lg:py-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            STEM <span className="text-primary">Club</span>
          </h1>
          ...
          <p className="font-body text-white/85 mt-6 max-w-xl" style={{ fontSize: "clamp(1rem, 1.4vw, 1.1rem)", lineHeight: 1.7 }}>
            Full details of the STEM Club programme are coming soon.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="border-t-2 border-accent pt-10 max-w-2xl">
            ...
            >
              Page <span className="text-primary">Coming Soon</span>
            </h2>
            <p className="font-body text-secondary leading-relaxed mb-8" style={{ fontSize: "clamp(1rem, 1.3vw, 1.1rem)" }}>
              We are currently building this page. In the meantime, you can
              contact us to learn more about the STEM Club programme.
            </p>
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-7 py-3 rounded-full bg-primary text-white font-body font-bold text-sm transition-opacity hover:opacity-90"
            >
              Contact Us
            </a>
          </div>
