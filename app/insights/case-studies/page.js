export const metadata = {
  title: "Case Studies | Blue Sands Academy",
  description: "BSA case studies — documented impact and programme outcomes.",
};
    ...
    <>
      <section className="relative bg-secondary overflow-hidden py-28 lg:py-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          <p className="font-body font-medium text-white/35 uppercase mb-8" style={{ fontSize: "0.7rem", letterSpacing: "0.18em" }}>Insights · Case Studies</p>
          <h1 className="font-display font-bold text-white max-w-2xl" style={{ fontSize: "clamp(3rem, 6.5vw, 6rem)", lineHeight: 1.0, letterSpacing: "-0.03em" }}>
            Case <span className="text-pink">Studies</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="border-t-2 border-pink pt-10 max-w-2xl">
            ...
            <p className="font-body text-secondary leading-relaxed" style={{ fontSize: "clamp(1rem, 1.3vw, 1.1rem)" }}>
              We are documenting our programme outcomes and will publish case studies here.
            </p>
          </div>
        </div>
      </section>
