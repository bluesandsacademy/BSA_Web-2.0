      ...
      <section aria-labelledby="emp-heading" className="py-16 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <div className="space-y-6">
              <FadeIn>
                <h2 id="emp-heading" className="section-title">
                  The Backbone of <span className="text-pink">Communities</span>
                </h2>
              </FadeIn>
              <FadeIn delay={80}>
            ...
            <FadeIn delay={100}>
              <blockquote className="border-l-4 border-pink pl-8 py-2">
                <p
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <FadeIn>
            <h2 id="focus-heading" className="section-title mb-16">
              What We <span className="text-pink">Provide</span>
            </h2>
          </FadeIn>
          ...
          <FadeIn>
            <div className="border-t-2 border-pink pt-10 max-w-2xl">
              <h2 className="section-title mb-5">
                Partner to <span className="text-pink">Empower</span>
              </h2>
