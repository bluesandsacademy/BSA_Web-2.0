...
export default function MilestoneCallout() {
  ...
  return (
    <section aria-labelledby="milestone-heading" className="py-28 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">

        <div
          ref={ref}
          className="bg-secondary rounded-2xl px-10 py-14 lg:px-16 lg:py-16 lg:grid lg:grid-cols-[5fr_6fr] lg:gap-20 lg:items-center"
        >
          {/* Left — headline + CTA */}
          <div
