...
const members = [
  { name: "Alero Thompson", role: "Founder / CEO", initials: "AT" },
...
function MemberChip({ member, index, visible }) {
  return (
    ...
    >
      ...
      <div>
        <p className="font-body font-semibold text-secondary text-sm leading-tight">
          {member.name}
        </p>
      ...
      <div ref={ref} className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <div
              className="rounded-full bg-accent mb-8"
            ...
            >
              ...
              who have committed their skills to one mission: closing the
