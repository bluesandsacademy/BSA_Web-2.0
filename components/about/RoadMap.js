    ...
    <>
      ...
      <section className="relative bg-secondary overflow-hidden py-28 lg:py-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            Where We've <span className="text-pink">Been</span>,<br />Where We're <span className="text-pink">Going</span>
          </h1>
      ...
      <section aria-labelledby="timeline-heading" className="py-16 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <h2 id="timeline-heading" className="section-title mb-16 lg:mb-20">
            BSA <span className="text-pink">Timeline</span>
          </h2>
                    ...
                    <div className="lg:text-right lg:pt-1">
                      <div className="flex lg:flex-col lg:items-end items-center gap-4 pl-6 lg:pl-0">
                        ...
                        <div
                          ...
                          style={{
                            top: "6px",
                            backgroundColor: m.accent ? "#E63F8E" : "white",
                            borderColor: m.accent ? "#E63F8E" : "#E2EBF6",
                          }}
                          aria-hidden="true"
                        />
                        <div
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="border-t-2 border-pink pt-10 max-w-2xl">
            <h2 className="section-title mb-5">
              Be Part of <span className="text-pink">What Comes Next</span>
            </h2>
