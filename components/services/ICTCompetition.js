    ...
    <>
      ...
      <section className="relative bg-secondary overflow-hidden py-28 lg:py-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            Tech <span className="text-primary">Competitions</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <FadeIn>
              <h2 id="comp-heading" className="section-title mb-8">
                Built to <span className="text-primary">Compete</span>
              </h2>
            ...
            <FadeIn delay={120}>
              <div className="bg-secondary rounded-2xl overflow-hidden p-8 lg:p-10">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-accent/20 border border-accent/30 flex items-center justify-center font-display font-bold text-white text-sm" aria-hidden="true">
                    SY
                  </div>
                  <div>
          ...
          <FadeIn>
            <div className="border-t-2 border-accent pt-10 max-w-2xl">
              <h2 className="section-title mb-5">
                Support the Next <span className="text-primary">Generation</span>
              </h2>
